...
if has("gui_running")
    ...
    hi MBEVisibleActive          guifg=#cfbfad   guibg=#2e2e3f
    hi MBEVisibleChangedActive   guifg=#eeeeee   guibg=#2e2e3f
    ...
    exec "hi SignColumn     cterm=NONE   ctermfg=" . <SID>X(7) . " ctermbg=" . <SID>X(80)

    exec "hi IncSearch      cterm=BOLD   ctermfg=" . <SID>X(7) . " ctermbg=" . <SID>X(48)
    exec "hi Search         cterm=NONE   ctermfg=" . <SID>X(7) . " ctermbg=" . <SID>X(48)
    ...
    exec "hi MBEVisibleActive            ctermfg=" . <SID>X(85) . " ctermbg=" . <SID>X(82)
    exec "hi MBEVisibleChangedActive     ctermfg=" . <SID>X(87) . " ctermbg=" . <SID>X(81)
